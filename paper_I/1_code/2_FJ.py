...
plt.tick_params(axis='both', which='major', labelsize=16)if exclude == 1:	if x_axis == "sigma":
		fig.savefig('../2_pipeline/2_FJ/Faber_Jackson_x-axis=sigma_EXC.pdf')	if x_axis == "M_r":
		fig.savefig('../2_pipeline/2_FJ/Faber_Jackson_x-axis=M_r_EXC.pdf')else:
	if x_axis == "sigma":
		fig.savefig('../2_pipeline/2_FJ/Faber_Jackson_x-axis=sigma.pdf')	if x_axis == "M_r":
		fig.savefig('../2_pipeline/2_FJ/Faber_Jackson_x-axis=M_r.pdf')
